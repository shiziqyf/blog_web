      ...
      <el-row type="flex" justify="center" class="blog-row">
        ...
        <el-col :span="24">
          <div class="blog-content">
            ...
            <div class="content">
              <mavon-editor class="content-html" v-html="contentHtml"></mavon-editor>
            </div>
          </div>
        </el-col>
        <el-col :span="3" class="hidden-md-and-down"></el-col>
...
export default {
  ...
  data() {
    return {
      ...
      blog: {},
      contentHtml: '<h1><a id="_0"></a>关于我</h1><ul><li>一个喜欢看电影的程序员</li><li>一个擅长后端开发的程序员</li><li>目前正在学习ios开发</li><li>目标成为一名能够养活自己的独立开发者</li></ul>',
